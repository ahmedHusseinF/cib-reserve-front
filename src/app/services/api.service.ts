...
export class ApiService {
  ...
  constructor(private http: Http, private flashMsg: FlashMessagesService) {
  ...
  postData(routeUrl: string, data: any, withToken = true): Observable<any> {
    this.loading = [1];
    ...
    return this.http
      .post(this.baseUrl + this.subUrl + routeUrl, body, options)
      .map(res => {
